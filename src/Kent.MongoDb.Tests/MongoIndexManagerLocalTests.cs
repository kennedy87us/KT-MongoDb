namespace Kent.MongoDb.Tests
{
    ...
    public class MongoIndexManagerLocalTests : IDisposable
    {
        ...
        public MongoIndexManagerLocalTests()
        {
            ...
            _mongoIndexManager = new MongoIndexManager(null, _mongoContext);
        ...
        public void CreateIndexesIfMissing_CreateEachIndexType_CreateIndex(MongoIndexType mongoIndexType)
        {
            ...
            var mongoIndexes = new List<MongoIndex>()
            {
                new MongoIndex(
                    indexName,
                    new List<MongoIndexField> {
                        new MongoIndexField<Test>(d => d.RefId, mongoIndexType)
                    })
            };
        ...
        private static BsonDocument GetIndex(IMongoCollection<Test> collection, string indexName)
        {
